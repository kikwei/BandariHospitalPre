...
<div class="container-fluid">
 ...
 if(isset($_POST['submit'])){
	 ...
	 $query="SELECT DISTINCT disease FROM diseases WHERE post_date  >='$startdate' AND post_date  <='$enddate' ORDER BY disease";
	 ...
	 while($rws=mysqli_fetch_array($result)){
       ...
       $count="SELECT  COUNT(disease) FROM diseases WHERE post_date >='$startdate' AND post_date <='$enddate' AND disease='$rws[0]'";
	 $resot=mysqli_query($connection,$count);
		...
		echo "<h4>Disease Reports From <b><i>$startdate</i></b> to <b><i>$enddate</i></b></h4>";
 ...
 ?>
   ...
   <p>NB:The above list consists ONLY of the diseases that occured within the given period.</P>
