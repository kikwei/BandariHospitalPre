...
<!doctype html>
    <html>
	  ...
	  <meta name="viewport" content="width=device-width, init-scale=1">
				...
				<h4 ><a href="change_pharmimage.php">Change Pic</a></h4>
				</div>
			</div>
        ...
        <div class="row">
				...
				<p style="color:#1e90ff"> NAME :</p>
					...
					<div class="row">
                <div class="col-md-4">	
			<p style="color:#1e90ff"> PF NUMBER:</p>
			</div>
			    <div class="col-md-8">
					 <?php echo "$rws[1]";?> <br />
					 </div></div>
			...
			<p style="color:#1e90ff">NATIONAL ID:</p>
				...
				<div class="col-md-8">
				 ...
				 <div class="row">
                <div class="col-md-4">
					 <p style="color:#1e90ff"> DEPARTMENT:</p>
					 </div>
					 <div class="col-md-8">
					   <?php echo "$rws[3]";?> <br /><br />
					 </div>
                ...
                <div class="col-md-4">
					 ...
					 <div class="col-md-8">
					   <?php echo "$rws[5]";?> <br /><br />
					 </div>
					 
					  </div>
					  <hr />
					 <!-- <h5><a href="#">Edit profile</a></h5><br /> -->
					  <h5><a href="pharmacy_staffhomepage.php">Back</a></h5>
		 </div>			  
		 </div>			  
					  <div class="col-md-2"></div>
					  </div>
